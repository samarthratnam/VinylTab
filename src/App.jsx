      ...
      <section className="about-section" aria-labelledby="about-vinyltab-title">
        <article className="about-card">
          ...
          <div className="about-copy">
            <section className="about-block" aria-label="Intro">
              <p className="about-intro">
                Hey guys <span aria-hidden="true">&#128075;</span>
              </p>
              <p>
                I built this because I got tired of ads interrupting my focus on Spotify and YouTube.
              </p>
              <p>
            ...
            <section className="about-block" aria-labelledby="about-how-to-use-title">
              <h3 id="about-how-to-use-title">How to Use</h3>
              <ul className="about-list">
                <li>Paste any YouTube playlist link and enjoy ad-free listening directly in your browser.</li>
                <li>Spotify playlists are not supported in the hosted version yet. To use Spotify, run the project locally.</li>
                <li>
                  You can also open VinylTab on your mobile browser for ad-free playback, but switching tabs or
                  apps will stop playback.
                </li>
              </ul>
            </section>

            <section className="about-block" aria-labelledby="about-controls-title">
              <h3 id="about-controls-title">Controls</h3>
              <ul className="about-shortcuts" aria-label="Keyboard shortcuts">
                <li>
                  <kbd className="about-key">P</kbd>
                  <span>Toggle Pomodoro timer</span>
                </li>
                <li>
                  <span className="about-key about-key-wide">Arrow Keys</span>
                  <span>Change tracks</span>
                </li>
              </ul>
            </section>

            <section className="about-block" aria-labelledby="about-connect-title">
              <h3 id="about-connect-title">Connect &amp; Explore</h3>
              ...
              <p>If you have suggestions, ideas, or feedback, feel free to reach out.</p>
            </section>
          </div>
        </article>
      </section>
